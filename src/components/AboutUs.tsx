      ...
      <div className="max-w-6xl mx-auto px-5 md:px-10">
        ...
        <div className="mb-10">
          ...
          >
            **Nossa Missão:** É proporcionar aos entusiastas de aquários
            ...
            estética de seus aquários, mas também contribuem significativamente
            para a saúde e o bem-estar de seus habitantes aquáticos. Buscamos
            profissionalismo em cada etapa, desde a seleção das espécies até o
            suporte ao cliente.
            <br />
            <br />
            **Nossa Visão:** Almejamos ser a referência no mercado de plantas e
            algas marinhas para aquários, reconhecidos pela nossa expertise,
            compromisso com a ecologia e pela capacidade de transformar aquários
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed">
                Através da fotossíntese, as plantas e algas liberam oxigênio na
                água, um elemento crucial para a respiração dos peixes e outros
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed">
                Algumas algas servem como fonte direta de alimento para certos
                peixes e invertebrados. Além disso, a matéria orgânica produzida
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed">
                As plantas e algas absorvem nutrientes como nitratos e fosfatos,
                que são subprodutos do metabolismo dos peixes e da decomposição
                de alimentos. Ao fazer isso, ajudam a manter a água limpa e
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed">
                Um aquário bem plantado oferece refúgios seguros para peixes e
                invertebrados, especialmente durante períodos de adaptação ou
                reprodução. A presença de plantas e algas também pode ajudar a
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed">
                Nossos biólogos marinhos possuem formação acadêmica sólida, com
                graduações e pós-graduações focadas no estudo dos ecossistemas
                oceânicos e da biologia das espécies marinhas. Sua expertise
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed">
                Nossos especialistas em aquicultura trazem consigo o
                conhecimento prático e teórico sobre as melhores técnicas de
                cultivo e manutenção de organismos aquáticos em ambientes
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed">
                Nossa equipe de suporte ao cliente é treinada para oferecer
                assistência profissional e amigável, desde a escolha das
                espécies mais adequadas para o seu aquário até dicas de
        ...
        <div className="mb-10">
          ...
          >
            ...
            Oceanografia, Aquicultura e áreas afins. O conhecimento aprofundado
            da biologia das espécies, das condições ideais de cultivo, das
            dinâmicas dos ecossistemas aquáticos e das melhores práticas de
